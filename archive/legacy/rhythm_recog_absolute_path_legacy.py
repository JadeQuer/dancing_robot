...
def rhythm_recog():
    play_audio('/home/pi/Desktop/1/resources/开始韵律识别.wav')
    record_music('/home/pi/Desktop/1/temp_record/song_temp.MP3', time=15)
    play_audio('/home/pi/Desktop/1/resources/结束录音.wav')
    all_data = np.load('/home/pi/Desktop/1/rhythm_train/onsetDatabase.npy', allow_pickle=True)
    beat_database = all_data.item()

    testAudio = "/home/pi/Desktop/1/temp_record/song_temp.MP3"
